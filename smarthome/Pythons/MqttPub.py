...
PORT = 1883
TOPIC = 'smarthome/74/topic'  # publish/subscribe에서 사용할 토픽(핵심)
...
try:
    ...
    while True:
        ...
        photo = random.randint(1,255)       # [Fake] 포토센서, 255쪽이 어두움 센싱. 실제로는 센서에서 값을 받아옴
        
        ## 센셍데이터를 json 형태로 변경
        ## OrderedDict로 먼저 구성. 수서가 있는 딕셔너리타입 객체
        ...
        # Python 딕셔너리 형태로 저장되어있음. json과 유사
